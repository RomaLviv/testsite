    ...
    <div class="team" id="team">
        <div class="container">
            <div class="block__head">
                ...
                <p class="block__text"><?= CFS()->get('team_text') ?></p>
            </div>
    ...
    <div class="contact" id="contact">
        <div class="container">
            <div class="block__head">
                ...
                <p class="block__text"><?= CFS()->get('contact_text') ?></p>
            </div>
            <div class="contact__inner">
                <div class="contact__icon-box">
                    <div class="contact__item">
                        <i class="icon-phone"></i>
                        <div class="contact__text"><a href="tel:<?= CFS()->get('contact_phone_numer') ?>"><?= CFS()->get('contact_phone_numer') ?></a></div>
                    </div>
                        <div class="contact__item">
                        <i class="icon-location"></i> 
                            <div class="contact__text">
                                    <a href="<?= CFS()->get ('contact_location_adress')['url']?>" 
                                    target="<?= CFS()->get ('contact_location_adress')['target']?>">
                                    <?= CFS()->get ('contact_location_adress')['text'] ?>
                                    </a>
                            </div>
                        </div>
                    ...
                    <div class="contact__item">
                        ...
                        <div class="contact__text"><a href="mailto:<?= CFS()->get('contact_mail_box') ?>"><?= CFS()->get('contact_mail_box') ?></a></div>
                    </div>
                    </div>
                </div>
